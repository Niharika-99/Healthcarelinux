...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function AppService(http) {
        ...
        this.http = http;
        this.rootURL = 'http://10.31.114.21:5000'; // rootURL = 'http://127.0.0.1:5000/';
          ...
          if (localStorage.getItem("CacheICD_10" + name)) {
            ...
            this.appService.getGridData(1, name).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroy$)).subscribe(function (gridData) {
              setTimeout(function () {
                ...
                localStorage.setItem("CacheICD_10" + name, JSON.stringify(_this6.FormattedData1));
          ...
          if (localStorage.getItem("CacheRelevantConcepts" + name)) {
            ...
            this.appService.getGridData(2, name).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroy$)).subscribe(function (gridData) {
              setTimeout(function () {
                ...
                localStorage.setItem("CacheRelevantConcepts" + name, JSON.stringify(_this7.FormattedData2));
          ...
          if (localStorage.getItem("CachePharmacologicalSubstance/ClinicalDrugs" + name)) {
            ...
            this.appService.getGridData(3, name).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroy$)).subscribe(function (gridData) {
              setTimeout(function () {
                ...
                localStorage.setItem("CachePharmacologicalSubstance/ClinicalDrugs" + name, JSON.stringify(_this8.FormattedData3));
          ...
          if (localStorage.getItem("CacheFindDrugCodes" + name)) {
            ...
            this.appService.getGridData(4, name).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroy$)).subscribe(function (gridData) {
              setTimeout(function () {
                ...
                localStorage.setItem("CacheFindDrugCodes" + name, JSON.stringify(_this9.FormattedData4));
                _this9.AgLoad = false;
              }, 4000);
            });
          }
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Cohort\healthcarelatest\my-app\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
